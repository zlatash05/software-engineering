...
### Составьте программу, результатом которой будет данный вывод в консоль. (Примечание: для формулировки этого задания требуется увидеть "данный вывод в консоль", поэтому, пожалуйста, предоставьте изображение или описание этого вывода).
```python
